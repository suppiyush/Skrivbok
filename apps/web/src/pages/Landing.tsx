...
const FEATURES = [
  {
    ...
    text: 'Create and manage projects with descriptions, team members and their roles, and progress tracking. Keep every project in one place.',
    tint: '#fdece0',
    fg: '#c2650b',
  },
  {
  ...
  },
  {
    ...
    text: 'See events, meetings and deadlines by day, week, month or as an agenda. Share your calendar with a teammate — anything that does not include them shows only as busy.',
  ...
  },
  {
    ...
    text: 'Organize research papers, articles and references. Add links, tags and your own summary, then find any of them again by tag.',
    tint: '#e8eaff',
    fg: '#4f5bd5',
  },
  {
    ...
    text: 'Keep a dated record of the work as it happens. Tag entries, search them later, and write up months of progress from what you already wrote down.',
    tint: '#e3f7e9',
    fg: '#2f9e57',
  },
  {
